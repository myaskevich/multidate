...
date.prototype.second = function(n) {
  ...
  this.update(seconds);
  if (this._changed['second'] !== undefined) this.dirty = true;
  this._changed['second'] = true;
  return this;
}
...
date.prototype.minute = function(n) {
  ...
  this.update(minutes);
  if (this._changed['minute'] !== undefined) this.dirty = true;
  this._changed['minute'] = true;
  return this;
}
...
date.prototype.hour = function(n) {
  var hours = +n * _hour;
  this.update(hours);
  if (this._changed['hour'] !== undefined) this.dirty = true;
  this._changed['hour'] = true;
  return this;
}
...
date.prototype.day = function(n) {
  var days = +n * _day;
  this.update(days);
  if (this._changed['day'] !== undefined) this.dirty = true;
  this._changed['day'] = true;
  return this;
}
...
date.prototype.week = function(n) {
  var weeks = +n * _week;
  this.update(weeks);
  if (this._changed['week'] !== undefined) this.dirty = true;
  this._changed['week'] = true;
  return this;
}
...
date.prototype.year = function(n) {
  ...
  if (this._changed['year'] !== undefined) this.dirty = true;
  this._changed['year'] = true;
  return this;
}
